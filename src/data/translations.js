...
const DICTIONARY = {
  ...
  badges: { 
    ...
    ru: {
      none: 'Нет', hero: 'Избранное', bestseller: 'Хит Продаж', popular: 'Популярное', premium: 'Премиум', signature: 'Фирменное',
    ...
    tr: {
      none: 'Yok', hero: 'Özel', bestseller: 'Çok Satan', popular: 'Popüler', premium: 'Premium', signature: 'İmza',
    ...
    tk: {
      none: 'Ýok', hero: 'Aýratyn', bestseller: 'Iň Köp Satylan', popular: 'Meşhur', premium: 'Premium', signature: 'Ýörite',
